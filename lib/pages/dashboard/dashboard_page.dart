...
import 'package:demoapp/service/auth_service.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       appBar: AppBar(
         title: Text('${userDetail.name}'.toUpperCase()),
